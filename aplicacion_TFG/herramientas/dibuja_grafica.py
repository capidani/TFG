...
caffe_path = '/home/user_cudnn/caffe/'
...
ax1.set_ylabel('perdidas', fontsize=15)
...
#Adding legend
plt.legend([train_loss, test_loss, test_accuracy], ['Perdida en Entrenamiento', 'Perdida en Test', 'Precision en test'],  bbox_to_anchor=(1, 0.8))
